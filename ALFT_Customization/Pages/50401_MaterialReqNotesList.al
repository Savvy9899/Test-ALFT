page 50401 MaterialRequestNoteList
{
    ApplicationArea = Location;
    Caption = 'Material Request Note List';
    CardPageID = MaterialRequestNotesCard;
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Release,Posting,Order,Documents,Print/Send,Navigate';
    SourceTable = "Transfer Header";
    SourceTableView = WHERE("Transfer Order Type" = CONST(MRN));
    UsageCategory = Lists;
