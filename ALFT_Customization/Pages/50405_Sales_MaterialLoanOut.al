page 50405 SalesmaterialOut
{
    Caption = 'Material Loan Out Card';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Material Loan No."; "Material Loan Out")
                {
                    ApplicationArea = All;
                }
                group(Control114)
    ...
    procedure PostSalesOrder(PostingCodeunitID: Integer; Navigate: Enum "Navigate After Posting")
    var
        SalesHeader: Record "Sales Header";
