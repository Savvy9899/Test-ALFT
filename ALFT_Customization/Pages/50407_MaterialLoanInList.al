page 50407 "Material Loan In List"
{
    ...
    begin
        ...
        // if "No. Series" <> PurchasesPayablesSetup."Material Loan In Nos." then
        // begin
        //     Cur
        // end;
