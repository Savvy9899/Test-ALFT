report 50435 "TotalStockReport-Consumption"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Stock Report with Consumption';
    RDLCLayout = 'Report_Layouts/ALFT-P-009_TotalStockReportWithConsumption.rdl';
    ...
    dataset
    {
        ...
        //         itemLed.Init();
        //         itemLed."Document No." := "Document No.";
        //         itemLed."Line No." := "Line No.";
        //         itemLed.Description := Description;
        //         itemLed."Posting Date" := "Posting Date";
        //         itemLed."Unit of Measure" := "Unit of Measure";
        //         // CalcFields("Amount Including VAT");
        //         itemLed."Amount Including VAT" := -"Amount Including VAT";
        //         // CalcFields(Quantity);
        //         itemLed.Quantity := Quantity;
        //         itemLed.Insert();
        //     end;
        ...
        dataitem(Integer; Integer)
        {
            ...
            { }
            column(prod_Ord_No; itemLed."Prod. Ord. No.")
            { }
            ...
            begin
                ...
                if item2.Get(itemLed."Source No.") then;
