report 50436 "PO Summary"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Report_Layouts/ALFT-S-002_PO_Summary.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            begin
                ...
                InvStDate := RStDate;
                InvEdDate := REdDate;
                SetRange("Document Date", RStDate, REdDate);
            end;
        ...
        dataitem(Integer; Integer)
        {
            ...
            { }
            column(CusName; TempSalesHedd."Sell-to Customer Name")
            { }
            ...
            trigger OnPreDataItem()
            begin
                TempSalesHedd.SETCURRENTKEY("Sell-to Customer No.", "No.");
                UpdateMonth;
            end;
            ...
            begin
                IF Number = 1 THEN BEGIN
                    IF NOT TempSalesHedd.FINDSET(FALSE, FALSE) THEN
                        CurrReport.BREAK;
                END ELSE
                    IF TempSalesHedd.NEXT = 0 THEN
                        CurrReport.BREAK;
