report 50408 "FG-SVAT Credit Note"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Report_Layouts/ALFT-F-010_FG-SVAT-Credit_Note.rdl';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                { }
                column(SVATCus; cusRec."SVAT Registration No.")
                { }
            ...
            begin
                ...
                comrec.Get;
                sVAtAmount := "Amount Including VAT" * (comrec."SVAT %" / 100);
