report 50401 "Check-Customized"
{
    ...
    procedure FormatNoTextCustomized(var NoText: array[2] of Text[80]; No: Decimal; CurrencyCode: Code[10])
    var
        PrintExponent: Boolean;
        Ones: Integer;
        Tens: Integer;
    ...
    begin
        ...
        IF (No = 0) OR (No = 1) THEN
            FinalCents[1] := OnesTextDecimalFirst[1] + ' CENT'
        ELSE
            FinalCents[1] := OnesTextDecimalFirst[1] + ' CENTS';
